    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}    
                ...
                \item Kernels are functions chosen to assume the distribution, used to generate a covariance matrix and that test points (variables) that are close should yield similar results (small covariance)
                \item Training data are then added to covariance matrix for evaluation, and are points kernl functions must pass through
                \item Kernels can be combined to yield better approximations
            \end{itemize}
        \end{itemize}
        \item Calibration
    \end{itemize}

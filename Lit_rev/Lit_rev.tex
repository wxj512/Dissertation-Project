...
Sobol method is a common GSA method for performing SA on the model parameters and has been applied to models in other fields, including biomechanics \cite{wirthl_global_2023} and pharmacology \cite{zhang_sobol_2015}. It is a variance-based method and divides the output variance to the contributing parameters of the model. As stated in \cite{wirthl_global_2023} and \cite{zhang_sobol_2015}, a sizeable sample is required for a reliable Sobol SA, with even smaller samples requiring ~1000 evaluations. 

...
Common surrogate models include functions such as polynomial chaos expansion, gaussian processes and low-rank tensor approximations that emulate the high-fidelity model with low computational cost \cite{sudret_surrogate_2017}. 
%TC:ignore
\begin{itemize}

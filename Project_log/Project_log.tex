...
\begin{arrowlist}
    ...
    \begin{figure}[h]
        ...
        \begin{subfigure}[c]{0.45\linewidth}
            \centering
            \includegraphics[width=0.9\linewidth]{Project_log/Fig/Fig1 blob2d example run.png}
        ...
        \begin{subfigure}[c]{0.45\linewidth}
            \centering
            \includegraphics[width=0.9\linewidth]{Project_log/Fig/Fig2 blob at t 400.png}
            \normalsize{\caption{Density of blob at t=400s}}
            \label{fig:fig2}
        \end{subfigure}
        \normalsize{\caption{Blob simulation using blob2d in built with BOUT++ using delta\_1 example}}
    \end{figure}

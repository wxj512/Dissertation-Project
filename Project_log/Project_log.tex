...
\item \textbf{Correction to Figure 4}
   ...
   \begin{figure}[H]
    ...
    \end{figure}  
                ...
                \item Additionally a gaussian peak could be fitted over the peak and the x position of the right side of the full width at half maximum (FWHM) of the gaussian function could be defined

    \begin{figure}[H]
        \centering
        \includegraphics[height=0.5\textheight]{./Fig/Fig10 n front FWHM plot.png}
        \normalsize{\caption{Density profile (blue line), peak position (orange "x") for density of blob and gaussian function fit (orange dash-dot line) and right position of FWHM for the gaussian fit (black dotted line) at mid row of z and t/(1/$\Omega_i$) at 5000}
        \label{fig:fig9}}
    \end{figure}  
    
                \item Equation for Gaussian
            \end{itemize}

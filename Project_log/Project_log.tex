...
\begin{arrowlist}
    ...
    \begin{figure}[H]
    \centering
        \includegraphics[height=0.3\textheight]{Project_log/Fig/Fig1 blob2d example run.png}
    ...
    \begin{figure}[H]
    \centering
        \includegraphics[height=0.5\textheight]{Project_log/Fig/Fig2 blob at t 400.png}
